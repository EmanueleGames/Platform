...
clStage3State::clStage3State()
{

    if (!mLayer0.createFromFile(gRenderer, "data/stage3_background.png"))
    {
        cout << "Layer 0 image loading failed!" << endl;
    }
    if (!mLayer1.createFromFile(gRenderer, "data/stage3_layer1.png"))
    {
        cout << "Layer 1 image loading failed!" << endl;
    }
    if (!mLayer2.createFromFile(gRenderer, "data/stage3_layer2.png"))
    {
        cout << "Layer 2 image loading failed!" << endl;
    }
    if (!mLayer3.createFromFile(gRenderer, "data/stage3_layer3.png"))
    {
        cout << "Layer 3 image loading failed!" << endl;
    }
    //if (!mLayer4.createFromFile(gRenderer, "data/stage3_layer4.png"))
    //{
    //    cout << "Layer 4 image loading failed!" << endl;
    //}

    //Music and SFX
    mBackgroundMusic = Mix_LoadMUS("data/stage3_music.mp3");
    ...
    load_tileset_map("data/stage3.map");
